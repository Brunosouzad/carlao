...
export const metadata: Metadata = {
  ...
  description: 'Conheça a história, missão e valores da Carlão Imóveis. Mais de 15 anos de tradição no mercado imobiliário de Governador Valadares e Coronel Fabriciano.',
