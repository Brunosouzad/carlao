...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl w-full bg-white lg:bg-white/90 lg:backdrop-blur-md rounded-2xl shadow-xl px-4 lg:px-8 py-1 flex items-center justify-between border border-black/5">
